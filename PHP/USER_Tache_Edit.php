...
<body>
  ...
  <div class="logo-details">
    ...
    <ul class="nav-list">
     ...
     <li>
       <a href="../PAGES/User_Tache.php" class='Tache'>
  ...
  <?php
    ...
    if (isset($_GET["ID"])) {
        ...
        echo "<input type='text' id='PrioriteTache' name='PrioriteTache' class='text-input-PrioriteTache' value='".$row["PrioriteTache"]."' readonly><br>";

        echo "<label for='DateDebutTache' class='TitreLabel'>DateDebutTache : </label>";
        echo "<input type='text' id='DateDebutTache' name='DateDebutTache' class='text-input-DateDebutTache' value='".$row["DateDebutTache"]."' readonly><br>";

        echo "<label for='DateMaxTache' class='TitreLabel'>DateMaxTache : </label>";
        echo "<input type='text' id='DateMaxTache' name='DateMaxTache' class='text-input-DateMaxTache' value='".$row["DateMaxTache"]."' readonly><br>";
        ...
        echo "<input type='button' name='annuler' class='BoutonAnnuler' value='Annuler' onclick='window.location.href=\"../PAGES/USER_Tache.php?utilisateur=" . $_SESSION['utilisateur']['IdUtilisateur'] . "\";'>";
        echo "</div>";
        echo "</form>";
    ...
    if (isset($_POST["valider2"])) {
        ...
        echo "<script> window.location.replace('../PAGES/USER_Tache.php?utilisateur=" . $_SESSION['utilisateur']['IdUtilisateur'] . "');</script>";
    }
?>
    </div>  
  </section>
